...
function postbackLocalstorage(payload) {
  ...
  if (this.storageAccess) {
    console.log('[BIFROST] postbackLocalStorage granted');
    ...
    console.log('[BIFROST] postbackLocalStorage denied, postponing...');
        ...
        switch (_context.prev = _context.next) {
          case 0:
            if (window.location.origin === 'http://localhost:3001') {
              ...
              bifrostClient = new _bifrost__WEBPACK_IMPORTED_MODULE_1__/* .default */ .Z( //'https://develop.teyvat.moe/map',
              'https://teyvat.moe/map', false, null, onStorageAccessSuccess, onStorageAccessFailure);
            } else {
