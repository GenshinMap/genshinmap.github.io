        ...
        switch (_context.prev = _context.next) {
          case 0:
            if (window.location.origin === 'http://localhost:3001') {
              bifrost = new _bifrost__WEBPACK_IMPORTED_MODULE_1__/* .default */ .Z('http://localhost:3000/map', false, null, onStorageAccessSuccess, onStorageAccessFailure);
            } else if (window.location.origin === 'https://genshinmap.github.io') {
              _bifrost = new _bifrost__WEBPACK_IMPORTED_MODULE_1__/* .default */ .Z('https://develop.teyvat.moe/map', false, null, onStorageAccessSuccess, onStorageAccessFailure);
            } else {
