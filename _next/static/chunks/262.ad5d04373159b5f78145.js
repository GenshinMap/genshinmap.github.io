        ...
        switch (_context.prev = _context.next) {
          case 0:
            if (window.location.origin === 'http://localhost:3000' || window.location.origin === 'https://localhost:3000' || window.location.origin === 'http://localhost:3001' || window.location.origin === 'https://localhost:3001') {
              ...
              if (document.referrer.startsWith('https://develop.teyvat.moe')) {
                // We are in the development environment.
                console.log("Referrer is ".concat(document.referrer, ", starting DEV connection."));
                ...
                console.log("Referrer is ".concat(document.referrer, ", starting prod connection."));
                bifrostClient = new _bifrost__WEBPACK_IMPORTED_MODULE_1__/* .default */ .Z('https://teyvat.moe/map', false, null, onStorageAccessSuccess, onStorageAccessFailure);
              }
            } else {
